...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['agregar'])) {
    if (!verificarPermisos($perfil, 'almacen', 'editar')) {
        die("No tienes permiso para agregar registros al almacén.");
    }
        ...
        <div class="button-group">
            <form method="POST" action="<?php 
                ...
                if ($_SESSION['perfil'] === 'root') {
                    ...
                    echo 'lorena.php'; // Redirige al menú de secretaria
                } elseif ($_SESSION['perfil'] === 'gerente') {
                    echo 'cristian.php'; // Redirige al menú de gerente
                } elseif ($_SESSION['perfil'] === 'empleado') {
                    echo 'jeremy.php'; // Redirige al menú de empleado
                }
            ?>">
